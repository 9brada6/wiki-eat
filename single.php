		...
		<div class="row">
			<div class="col-lg-8">
				<article id="post-<?php the_ID(); ?>" <?php post_class( 'bg-white border rounded shadow' ); ?>>
					...
					<?php get_template_part( 'templates/post/aliment-carousel' ); ?>

					<?php get_template_part( 'templates/post/aliment-ingredients-text' ); ?>

					<?php get_template_part( 'templates/post/aliment-ingredients-bar' ); ?>
			...
			<div class="col-lg-4">
				<aside class="bg-light border rounded shadow overflow-hidden">
